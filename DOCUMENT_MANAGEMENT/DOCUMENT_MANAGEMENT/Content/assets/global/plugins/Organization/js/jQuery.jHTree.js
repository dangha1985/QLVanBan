...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _createNode: function (node, parentLiNode) {
            ...
            //phúc sửa 13/12
            var nodeLiElements = '<li id="' + node.id + '" class="tnode" >' + beforeDiv + '<div class="trcont"><div class="ui-widget-header ui-corner-tl ui-corner-tr col-md-4"><img src="' +
               node.photo + '" class="p-img"  onerror="this.src=\'../Content/assets/global/img/EmployeeDefault.jpg\'"  ></div><div class="ui-widget-content ui-corner-bl ui-corner-br col-md-8" leaderId="' + node.leaderId + '"><div class="col-md-12 p-head">' +
                node.contents + '</div><div class="col-md-12 p-body">'+ node.head +'</div></div></div><div class="trchl"><ul>' +
                bfrul + '</ul></div>' + afterDiv + '</li>';
        ...
        _interactionEvents: function () {
            ...
            // phúc sửa 14/12  > .ui-widget-header
